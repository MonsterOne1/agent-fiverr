...
- Number and type of deliverables: captioned_video, short_clips, transcript, asset_manifest.
- Required provider APIs: openai_responses, seedance, kling, renoise, elevenlabs.
- Automation level: L4.
- Risk level: medium.
